...
<div class="container">
  <form:form method="post" modelAttribute="lecture">
    <div class="title">강의  ${ lecture.id > 0 ? "수정" : "등록" }</div>
    <table>
      <tr>
        <td>강좌명 :</td>
      ...
      <tr>
        ...
        <td><form:select path="professorId"
                itemValue="id" itemLabel="name" items="${ professors }" /></td>
      </tr>
      <tr>
        <td>년도 :</td>
      ...
      <tr>
        <td>학기 :</td>
        <td><form:input path="semaster" /></td>
      </tr>
      <tr>
        <td>교실번호  :</td>
    ...
    <div>
      ...
      <c:if test="${ lecture.id > 0 }">
        <a href="delete?id=${ lecture.id }" class="btn" data-confirm-delete>삭제</a>
      </c:if>
