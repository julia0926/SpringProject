...
<div class="container">
  <form:form method="post" modelAttribute="course">
    <div class="title">강좌  ${ course.id > 0 ? "수정" : "등록" }</div>
    <table>
      <tr>
        <td>강좌이름:</td>
      ...
      <tr>
        ...
        <td><form:select path="professorId"
                itemValue="id" itemLabel="professorName" items="${ professors }" /></td>
      </tr>
      <tr>
        <td>시작일 :</td>
    ...
    <div>
      ...
      <c:if test="${ course.id > 0 }">
        <a href="delete?id=${ course.id }" class="btn" data-confirm-delete>삭제</a>
      </c:if>
